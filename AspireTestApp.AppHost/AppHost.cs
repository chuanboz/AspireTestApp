...
database.AddContainer(
    AspireConstants.Resources.CosmosWeatherContainer,
    partitionKeyPath: AspireConstants.CosmosDb.WeatherPartitionKeyPath,
    containerName: AspireConstants.CosmosDb.WeatherContainerName);
database.AddContainer(
